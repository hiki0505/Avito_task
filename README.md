...
Программа покрыта тестом, проверяющая соответствие ожидаемого и реального результата. Исключения и серверные ошибки также обработаны в специально файле под названием <i> exceptions.py </i>
